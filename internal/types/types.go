...
const (
	ManualGearMinRPM = FanSpeedMinPercent
	ManualGearMaxRPM = FanSpeedMaxPercent
)
...
func GetDefaultFanCurve() []FanCurvePoint {
	return []FanCurvePoint{
		{Temperature: 20, RPM: 0},
		{Temperature: 25, RPM: 10},
		{Temperature: 30, RPM: 18},
		{Temperature: 35, RPM: 24},
		{Temperature: 40, RPM: 30},
		{Temperature: 45, RPM: 36},
		{Temperature: 50, RPM: 42},
		{Temperature: 55, RPM: 48},
		{Temperature: 60, RPM: 55},
		{Temperature: 65, RPM: 62},
		{Temperature: 70, RPM: 70},
		{Temperature: 75, RPM: 78},
		{Temperature: 80, RPM: 86},
		{Temperature: 85, RPM: 92},
		{Temperature: 90, RPM: 96},
		{Temperature: 95, RPM: 100},
		{Temperature: 100, RPM: 100},
		{Temperature: 105, RPM: 100},
