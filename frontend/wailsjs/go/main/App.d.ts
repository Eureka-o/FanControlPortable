...
export function DeletePlugin(arg1:string):Promise<plugins.CatalogSnapshot>;
...
export function GetPluginSnapshot():Promise<plugins.CatalogSnapshot>;
...
export function InvokePlugin(arg1:string,arg2:string,arg3:any):Promise<any>;
...
export function RefreshPlugins():Promise<plugins.CatalogSnapshot>;

export function ReinstallPawnIO():Promise<Record<string, any>>;

export function ResetLearnedOffsets():Promise<void>;

export function ResetPlugin(arg1:string):Promise<plugins.CatalogSnapshot>;
...
export function SetPluginEnabled(arg1:string,arg2:boolean):Promise<plugins.CatalogSnapshot>;
