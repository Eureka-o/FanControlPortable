...
export namespace plugins {
	...
	export class PageManifest {
	    ...
	    static createFrom(source: any = {}) {
	        return new PageManifest(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.iconAsset = source["iconAsset"];
	...
	export class CatalogEntry {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.runtimeCapabilities = source["runtimeCapabilities"];
	        this.telemetryInputs = source["telemetryInputs"];
	        this.frontend = source["frontend"];
	        this.style = source["style"];
	        this.page = this.convertValues(source["page"], PageManifest);
	    }
	...
	export class CatalogSnapshot {
	    ...
	    static createFrom(source: any = {}) {
	        return new CatalogSnapshot(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.revision = source["revision"];
	        this.plugins = this.convertValues(source["plugins"], CatalogEntry);
