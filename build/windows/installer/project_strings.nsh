...
LangString THRM_STR_DESC_AUTOSTART ${LANG_SIMPCHINESE} "系统启动时自动运行 FanControl Core。推荐开启。"
LangString THRM_STR_DESC_AUTOSTART ${LANG_ENGLISH} "Start FanControl Core automatically when Windows starts. Recommended."
LangString THRM_STR_DESC_AUTOSTART ${LANG_JAPANESE} "Windows 起動時に FanControl Core を自動実行します。推奨です。"
...
LangString THRM_STR_CLOSE_CORE ${LANG_SIMPCHINESE} "已请求关闭 FanControl Core.exe..."
LangString THRM_STR_CLOSE_CORE ${LANG_ENGLISH} "Requested FanControl Core.exe to close..."
LangString THRM_STR_CLOSE_CORE ${LANG_JAPANESE} "FanControl Core.exe の終了を要求しました..."
...
LangString THRM_STR_STOP_CORE ${LANG_SIMPCHINESE} "正在停止 FanControl Core.exe..."
LangString THRM_STR_STOP_CORE ${LANG_ENGLISH} "Stopping FanControl Core.exe..."
LangString THRM_STR_STOP_CORE ${LANG_JAPANESE} "FanControl Core.exe を停止しています..."
...
LangString THRM_STR_STOP_BRIDGE ${LANG_SIMPCHINESE} "正在停止 FanControl TempBridge.exe..."
LangString THRM_STR_STOP_BRIDGE ${LANG_ENGLISH} "Stopping FanControl TempBridge.exe..."
LangString THRM_STR_STOP_BRIDGE ${LANG_JAPANESE} "FanControl TempBridge.exe を停止しています..."
